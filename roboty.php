...
?>
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800">Roboty <small>(Booty)</small></h1>
	</div>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table  class="table table-striped small table-sm" data-order=\'[[ 1, "DESC" ]]\' data-page-length=\'10\' class="display" id="dataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr class="text-primary">
						<th>roboty</th> <th>odsłony</th> <th style="min-width: 100px;">wykres</th> <th>data</th> <th>user agent</th> <th>usuń</th>
                    </tr>
                  </thead>
                  <tfoot>
                    <tr class="text-primary">
				...
				$stmt = $db->query("SELECT * FROM `roboty` ORDER BY `roboty`.`wejscia` DESC");
						...
						<div class="modal-dialog modal-lg">
							<div class="modal-content">
								...
								<div class="modal-footer">
										...
										<button type="submit" class="btn btn-success" name="wyslij_14" title="tak usuń">Tak</button>
									</form>
								</div>
