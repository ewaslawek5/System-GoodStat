...
?>
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800">Żródło</h1>
	</div>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table  class="table table-striped small table-sm" data-order=\'[[ 2, "DESC" ]]\' data-page-length=\'10\' class="display" id="dataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr class="text-primary">
						<th>#</th> <th>źródło</th> <th>odsłony</th> <th>wykres</th> <th>data</th> <th>usuń</th>
                    </tr>
                  </thead>
                  <tfoot>
                    <tr class="text-primary">
				...
				$stmt = $db->query("SELECT * FROM `klikzestr` ORDER BY `klikzestr`.`wejscia` DESC");
